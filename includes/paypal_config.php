...
define("PP_USER_SANDBOX", "ichbinerste_api1.gmail.com");
define("PP_PASSWORD_SANDBOX", "SK9VUF2DKQXAVRGD");
define("PP_SIGNATURE_SANDBOX", "ACm8s3Up3EVi1Y-CiX2IsTfba7aDAHfLnJi8p6SiTrKASqVbsJGPNydN");

//Seller Live credentials.
define("PP_USER","ichbinerste_api1.gmail.com");
define("PP_PASSWORD", "SK9VUF2DKQXAVRGD");
define("PP_SIGNATURE","ACm8s3Up3EVi1Y-CiX2IsTfba7aDAHfLnJi8p6SiTrKASqVbsJGPNydN");
...
if(USERACTION_FLAG){
	$page = '/includes/return.php';
} else {	
	$page = '/includes/review.php';
}
